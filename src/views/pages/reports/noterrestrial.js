...
const Reports = () => {
  ...
  const page = UtilsData.SIDEBAR["reports"].find(a => a.option === "noterrestrial");
            ...
            <CRow>
              <CCol>
                <iframe
                  ...
                  width="100%"
                  height={height}
                  src={ConfigData.TABLEAU_NOTERRESTRIAL + "?:showAppBanner=false&:display_count=n&:showVizHome=n&:origin=viz_share_link&:embed=y&:host_url=https://tableau-public.discomap.eea.europa.eu/&:refresh=true"}
                >
                </iframe>
              </CCol>
            </CRow>
