...
export class ModalChanges extends Component {
  ...
  checkForChanges(e) {
    ...
    let changed = this.state.fields.SiteName !== body.SiteName
      || this.state.fields.Area !== body.Area
      || bioRegionChanged
      || (e && e.value !== undefined ? this.state.fields.SiteType !== e.value : false);
        ...
        <>
          ...
          <CModalFooter>
            <div className="d-flex w-100 justify-content-between">
              ...
              {data.Status === 'Pending' && <CButton disabled={this.changingStatus} className="green" color="primary" onClick={() => this.checkUnsavedChanges() ? this.messageBeforeClose(() => this.acceptChangesModal(true), true) : this.acceptChangesModal()}>Accept Changes</CButton>}
