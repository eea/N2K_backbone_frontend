          ...
          list.push(
            <div key={"change_" + levels[l] + "_" + j + "_" + title} className="collapse-container">
              <div className="d-flex gap-2 align-items-center justify-content-between" key={i + "_" + j}>
                ...
                <div>
                  {this.state.data.Status === "Pending" && (changes[i][j].ChangeCategory == "Lineage" && this.props.lineageChangeType !== "NoChanges" && this.props.lineageChangeType !== "NoGeometryReported" && this.props.lineageChangeType !== "NewGeometryReported") &&
                    <>
