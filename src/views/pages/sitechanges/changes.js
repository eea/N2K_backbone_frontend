                ...
                <CCol sm={12} md={6} lg={6} className="mb-4">
                  <div className="select--right">
                    <CFormLabel htmlFor="country_select" className="form-label form-label-reporting col-md-4 col-form-label">Country </CFormLabel>
                      <CFormSelect id="county_select" aria-label="Country select" className="form-select-reporting" disabled={loadingSites || statusLoaded.length !== 3} value={country} onChange={(e)=>changeCountry(e.target.value)}>
                      {
